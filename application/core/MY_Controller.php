...
class MY_Controller extends CI_Controller
{
    ...
    public function pagination_config($base_url,$total_rows,$per_page){
        ...
        $config['cur_tag_open'] = '<li class="page-item active"><a class="page-link" href="#" tabindex="-1" aria-disabled="true" >';
        $config['cur_tag_close'] = '</a></li>';
        $config['prev_tag_open'] = '<li class="page-item">';
        $config['prev_tag_close'] = '</li>';
        $config['first_link'] = '<i class="bi bi-chevron-double-left"></i> '.$this->lang->line("text_first");
        $config['first_tag_open'] = '<li class="page-item">';
        $config['first_tag_close'] = '</li>';
        $config['last_link'] = $this->lang->line("text_last").' <i class="bi bi-chevron-double-right"></i>';
        $config['last_tag_open'] = '<li class="page-item">';
        $config['last_tag_close'] = '</li>';
        $config['prev_link'] = '<i class="bi bi-chevron-double-left"></i> '.$this->lang->line("text_previous");
        $config['prev_tag_open'] = '<li class="page-item">';
        $config['prev_tag_close'] = '</li>';
        $config['next_link'] = $this->lang->line("text_next").' <i class="bi bi-chevron-double-right"></i>';

    ...
    <table class="table table-hover">
        ...
        <tbody>
            ...
            <tr>
				...
				<td>
                    <?php if(isset($permission['delivery_agent']) && $permission['delivery_agent']!=NULL) { ?>
                        <div class="toggle lg">
                            <label>
                                <input type="checkbox" class="toggle-button" data-role-permission-id="<?= $permission['delivery_agent']['id'] ?>" <?php if($permission['delivery_agent']['is_permitted']==1) { ?>checked<?php } ?>><span class="button-indecator"></span>
                            </label>
                        </div>
                    <?php } ?>
                </td>
				<td>
                    <?php if(isset($permission['inventory_guy']) && $permission['inventory_guy']!=NULL) { ?>
                        <div class="toggle lg">
                            <label>
                                <input type="checkbox" class="toggle-button" data-role-permission-id="<?= $permission['inventory_guy']['id'] ?>" <?php if($permission['inventory_guy']['is_permitted']==1) { ?>checked<?php } ?>><span class="button-indecator"></span>
                            </label>
                        </div>
                    <?php } ?>
                </td>

<div class="row">
   <div class="col-12 col-xl-4">
      <div class="card">
         ...
         <div class="card-body">
            <form method="POST" action="<?= base_url('admin/cities/add_cities'); ?>" enctype="multipart/form-data" accept-charset="utf-8">
               <div class="mb-3">
                  <label class="form-label">City Name</label>
                  <input name="amenity_name" type="text" class="form-control" placeholder="Enter City here...">
               </div>
		 ...
		 <table class="table" style="width:100%;height:100%;">
            <thead>
               <tr>
                  ...
                  <th class="d-none d-md-table-cell" style="width:35%">State</th>
                  <th>Actions</th>
               </tr>
            </thead>
            <tbody>

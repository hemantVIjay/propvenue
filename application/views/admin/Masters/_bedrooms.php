<div class="row">
         ...
         <div class="card-body">
            <form method="POST" action="<?= base_url('admin/masters/add_bedroom'); ?>" enctype="multipart/form-data" accept-charset="utf-8">
               ...
               <div class="mb-3">
                  ...
                  <img src="<?= base_url('uploads/bedrooms/');?><?= $record->icon ?? ''; ?>" style="10px 0px;">
                  <?php } ?>
               </div>
   ...
   <div class="col-12 col-xl-8">
      <div class="card">
         <div class="card-header">
            <h5 class="card-title">Floor Type Lists</h5>
         </div>
         <div style="overflow:auto;max-height:525px;">
            <table class="table" style="width:100%;height:100%;">
               ...
               <tbody>
                  <?php $i=0;
                     foreach($bedrooms as $key=>$row){ $cls = ($i % 2); ?>
                  <tr class="<?php if($cls==0){ ?>table-success<?php } ?>">
                     <td><?= $i+1; ?></td>
                     <td><?= $row->name; ?></td>
                     <td><img src="<?= base_url('uploads/bedrooms/');?><?= $row->icon; ?>"/></td>

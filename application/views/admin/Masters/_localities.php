		 ...
		 <table class="table" style="width:100%;height:100%;">
            ...
            <tbody>
			   ...
			   <tr class="<?php if($cls==0){ ?>table-success<?php } ?>">
                  <td><?= $i+1; ?></td>
                  <td><?= $row->name; ?></td>
                  <td><?php $ct = $this->masters->get_record_id('cities',$row->city_id); echo$ct->name; ?></td>
                  <td><?php $st = $this->masters->get_record_id('states',$row->state_id); echo$st->name; ?></td>
                  <td><?php $cn = $this->masters->get_record_id('countries',$row->country_id); echo$cn->name; ?></td>

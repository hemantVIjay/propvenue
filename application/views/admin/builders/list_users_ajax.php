    ...
    <div class="action-dropdown">
        <div class="btn-group">
            ...
            <div class="dropdown-menu dropdown-menu-right">
                ...
                <?php } ?>
				<?php if($permissions['edit_user']==TRUE) { ?>
                    <?php if($user['role_slug']=='delivery_agent') { ?>
                        <a class="dropdown-item" href="<?php echo base_url(); ?>admin/users/assign_location/<?= $user['id']; ?>" data-id="<?= $user['id']; ?>"><i class="feather icon-map"></i> Assign Locations</a>
                    <?php } ?>
                <?php } ?>
            </div>
        </div>
